		...
		if($data != null)
		{
			$tabla = 	"<div class='card-panel paneles'>
				...
				foreach($data as $row)
				{
					...
					$tabla .=	"<td>
										<a href='save.php?id=$row[carnet]' class='btn blue'><i class='material-icons'>edit</i></a>
										<a href='delete.php?id=$row[carnet]' class='btn red'><i class='material-icons'>delete</i></a>
									</td>
								</tr>";
				}
				$tabla .= "</tbody>
