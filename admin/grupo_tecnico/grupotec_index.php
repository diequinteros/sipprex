			...
			$tabla = 	"<div class='card-panel paneles'>
				...
				foreach($data as $row)
				{
					$tabla .= 	"<tr>
									...
									<td>$row[grupo_tec]</td>
									<td>
										<a href='save.php?id=$row[id_grupo_tec]' class='btn blue'><i class='material-icons'>edit</i></a>
										<a href='delete.php?id=$row[id_grupo_tec]' class='btn red'><i class='material-icons'>delete</i></a>
									</td>
								</tr>";
				}
				$tabla .= "</tbody>
