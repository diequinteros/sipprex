			...
			$tabla = 	"<div class='card-panel paneles'>
				...
				foreach($data as $row)
				{
					$tabla .= 	"<tr>
									...
									<td>
										<a href='save.php?id=$row[id_depar]' class='btn blue'><i class='material-icons'>edit</i></a>
										<a href='delete.php?id=$row[id_depar]' class='btn red'><i class='material-icons'>delete</i></a>
									</td>
								</tr>";
				}
				$tabla .= "</tbody>
